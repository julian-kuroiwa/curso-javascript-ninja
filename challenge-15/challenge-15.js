(function() {
    ...
    */
    ...
    var julian = new Person("Julian", "Kuroiwa", 27);
    var josiane = new Person("Josiane", "Garotti", 23);
    var jose = new Person("José", "Lopes", 50);
    ...
    */
    ...
    console.log(josiane.getFullName());
    ...
    */
    ...
    console.log(julian.getFullName() + " tem " + julian.getAge() + " anos.");
    console.log(josiane.getFullName() + " tem " + josiane.getAge() + " anos.");
