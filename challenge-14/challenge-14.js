(function() {
    ...
    */
    ...
    var operation = justMod2Or3.reduce(function(acumulate, actual, index, array) {
    ...
    */
    ...
    var operation2 = justMod2Or3.reduceRight(function(acumulate, actual, index, array) {
        return (acumulate + 1) * actual;
    }, 0)
    ...
    */
    ...
    var reduce = name.reduce(function(acumulate, actual) {
    ...
    */
    ...
    var lastIndexOf = numberObjects.lastIndexOf({ number: 2 }, 2);
