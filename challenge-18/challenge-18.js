(function() {
    ...
    */
    ...
    var emptyHtml = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";
    ...
    */
    ...
    var markReplace = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";

    console.log(markReplace.replace(/(<\w+>)([\sA-Za-zÀ-ü]+)(<\/\w+>)/g, function(regex, arg1, arg2, arg3) {

        return arg1 + 'O texto dentro da tag ' + arg1.replace(/[><]/g, '') + ' é "' + arg2 + '"' + arg3 + '\n';
    }));
